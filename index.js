...
console.log(createMenuItem("Sundae", 9, "Dessert"));
...
console.log(createMenuItem("Tator Tots", 4, "Sides"));
console.log(createMenuItem("Reuben", 11, "Lunch"));
console.log(createMenuItem("Cotton Candy", 5, "Dessert"));
...
reviews.push({name: "Clare", rating: 5, feedback: "I will be back next week!"});
